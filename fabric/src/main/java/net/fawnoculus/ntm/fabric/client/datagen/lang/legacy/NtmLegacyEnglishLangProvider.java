...
public class NtmLegacyEnglishLangProvider extends NtmCommonLangProvider {
    public NtmLegacyEnglishLangProvider(FabricDataOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
        super(dataOutput, "en_us", registryLookup);
    }

    @Override
    public void generateTranslations(HolderLookup.@NonNull Provider registryLookup, @NonNull TranslationBuilder builder) {
        builder.add(Items.COPPER_INGOT, "Industrial Grade Copper");
        ...
        addDownloadedTranslations("en_US", builder);
    }
}
