...
/**
 * Indicates that an annotated Element should only be used on the Server, as calling it on the Client may cause undefined behavior, or simply doesn't work correctly.<br>
