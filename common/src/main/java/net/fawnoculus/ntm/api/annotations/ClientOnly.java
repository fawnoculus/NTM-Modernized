...
/**
 * Indicates that an annotated Element should only be used on the Client, as calling it on the Server may cause undefined behavior, or simply doesn't work correctly.
