...
public class NtmLegacyItalianLangProvider extends NtmCommonLangProvider {
    public NtmLegacyItalianLangProvider(FabricDataOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
    ...
    public void generateTranslations(HolderLookup.@NonNull Provider registryLookup, @NonNull TranslationBuilder builder) {
        ...
        addDownloadedTranslations("it_IT", builder);
    }
}
