...
public class NtmLegacyFrenchLangProvider extends NtmCommonLangProvider {
    public NtmLegacyFrenchLangProvider(FabricDataOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
    ...
    public void generateTranslations(HolderLookup.@NonNull Provider registryLookup, @NonNull TranslationBuilder builder) {
        ...
        addDownloadedTranslations("fr_FR", builder);
    }
}
